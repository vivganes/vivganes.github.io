...
image:
  feature: 'http://vivekganesan.com/images/inverted_delegation_poker.PNG'
---
...
## Step - 1: Design of Inverted Delegation Poker Deck

I know about an exercise called [Delegation poker](https://management30.com/product/delegation-poker/) that I read in the book [Managing for Happiness](https://management30.com/product/managing-for-happiness/). However, that exercise is to come up with a working agreement for a future state whereas here, my problem is to highlight the current state and the communication gap.
...
1. Activity with the team using an Inverted Delegation Poker card deck, that I created.
...
Thanks, Jurgen for providing me a thinking tool :) 
